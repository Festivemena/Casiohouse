...
export default function App() {
  ...
  return (
    <View style={tw`bg-black h-full text-center items-center justify-center `}>
      <Text style={tw`text-white font-black pt-[92px] text-[28px]`}>Enter OTP</Text>
      <Text style={tw`text-[12px] text-center mt-1 text-white mx-8`}>Enter OTP sent to your email</Text>
      <View style={tw`mt-4 w-full px-8 text-white`}>
        <Text style={tw`text-white mb-1`}>OTP:</Text>
